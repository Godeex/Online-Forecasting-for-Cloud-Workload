...
parser.add_argument('--aug', type=int, default=1, help='Training with augmentation data aug iterations')
...
parser.add_argument('--use_adbfgs', action='store_true', help='use the Adbfgs optimizer', default=False)
...
data_parser = {
    ...
    'g_001':{'data':'g_cluster_2011_003.csv', 'T':'cpu_usage', 'S':[1,1,1], 'M':[3,3,3]},
    'ali_2018_1':{'data':'ali_2018/ali_1934_1T.csv', 'T':'cpu_util_percent', 'S':[1,1,1], 'M':[3,3,3],},
    'ali_2018_2':{'data':'ali_2018/ali_1935_1T.csv', 'T':'cpu_util_percent', 'S':[1,1,1], 'M':[3,3,3],},
    'ali_2018_3':{'data':'ali_2018/ali_1936_1T.csv', 'T':'cpu_util_percent', 'S':[1,1,1], 'M':[3,3,3],},
    'ali_2018_4':{'data':'ali_2018/ali_1938_1T.csv', 'T':'cpu_util_percent', 'S':[1,1,1], 'M':[3,3,3],},
    'ali_2018_5':{'data':'ali_2018/ali_1940_1T.csv', 'T':'cpu_util_percent', 'S':[1,1,1], 'M':[3,3,3],},
    'ali_2018_6':{'data':'ali_2018/ali_1942_1T.csv', 'T':'cpu_util_percent', 'S':[1,1,1], 'M':[3,3,3],},
